...
{document}
=====
Here are the product lists, and be sure you first recommend the higher-performance one:
PRODUCT LIST:\n
{product_info}
\nIF PRODUCT LIST IS EMPTY, RECOMMEND ONE IN THE CHAT HISTORY
\nIMPORTANT: DO NOT MAKE UP PRODUCTS THAT IS NOT IN THE PRODUCT LIST. DO NOT GIVE PRODUCT WITH DOWNGRADE EQUPMENT. 1 YEAR WARRANTY IS A MUST, DO NOT REDUCE WARRANTY. GIVE PRODUCT THAT IS IN THE PRODUCT LIST, IF IT IS STILL OVERBUDGET, TRY APPLY THE PROMO CODE AND SEE IF IT IS WITHIN THE BUDGET, ELSE PERSUADE THE CUSTOMER TO BUY PRODUCTS IN THE CHAT HISTORY WITH PROMO CODE.\n
=====
{chat_history}
###Customer: {question}
###Sales: """
        ...
        template = f"{B_S}{B_INST} {B_SYS}{system_msg}{document_prompt_variable}{product_prompt_variable}{rule_variable}{E_SYS}{history_prompt_variable}{user_prompt_variable} {E_INST}"
        prompt = PromptTemplate(input_variables=["product_info", "document", "question", "chat_history"], template=template)
        return prompt
    else:
